...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        new_state = State(name="Kensas")
        new_state.save()
        new_user = User(email="jack@foobar.com", password="password")
        new_user.save()
        self.assertIs(new_state, models.storage.get("State", new_state.id))
        self.assertIs(None, models.storage.get("State", "CA"))
        self.assertIs(None, models.storage.get("CA", "CA"))
    ...
    def test_count(self):
        ...
        self.assertEqual(models.storage.count("ca"), 0)
